...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shift_param', full_name='caffe.LayerParameter.shift_param', index=61,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='irnn_param', full_name='caffe.LayerParameter.irnn_param', index=62,
...
_SHIFTPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.ShiftParameter.stride', index=0,
...
_IRNNPARAMETER = _descriptor.Descriptor(
  name='IRNNParameter',
  full_name='caffe.IRNNParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight_fixed', full_name='caffe.IRNNParameter.weight_fixed', index=0,
...
_LAYERPARAMETER.fields_by_name['irnn_param'].message_type = _IRNNPARAMETER
...
DESCRIPTOR.message_types_by_name['IRNNParameter'] = _IRNNPARAMETER
...
IRNNParameter = _reflection.GeneratedProtocolMessageType('IRNNParameter', (_message.Message,), dict(
  DESCRIPTOR = _IRNNPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.IRNNParameter)
  ))
_sym_db.RegisterMessage(IRNNParameter)
