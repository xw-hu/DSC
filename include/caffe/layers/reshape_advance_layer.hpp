...
class ReshapeAdvanceLayer : public Layer<Dtype> {
 public:
  explicit ReshapeAdvanceLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ReshapeAdvance"; }
