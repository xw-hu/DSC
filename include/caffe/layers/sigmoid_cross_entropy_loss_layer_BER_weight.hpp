#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_BER_WEIGHT_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_BER_WEIGHT_HPP_
...
class SigmoidCrossEntropyLossBERweightLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossBERweightLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossBERweight"; }

 protected:
  /// @copydoc SigmoidCrossEntropyLossBERweightLayer
...
#endif  // CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_LAYER_BER_WEIGHT_HPP_
